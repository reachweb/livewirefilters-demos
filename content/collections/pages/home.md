...
builder:
  ...
  -
    ...
    grid:
      ...
      - id: 7IIgnAD7OJHlqlpjZTwT2
        title: 'Infinite Scroll'
        text: 'Automate pagination using infinite scrolling or use a "Load more" button.'
        icon: svg/infinite-scroll.svg
        link: 'entry::a1f3c2d4-7b6e-4f1a-9c2d-inf1n1tescr0ll'
